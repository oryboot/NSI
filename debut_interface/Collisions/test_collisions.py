...
class Perso:
    ...
    def __init__(self, nom, x, y):
        self.l_sprites = {
            'haut': [pygame.image.load("animations_sprites/images/" + nom + '_h' + str(i) + '.png') for i in
                     range(1, 10)],
            'bas': [pygame.image.load("animations_sprites/images/" + nom + str(i) + '.png') for i in range(1, 10)],
            'droite': [pygame.image.load("animations_sprites/images/" + nom + '_d' + str(i) + '.png') for i in
                       range(1, 9)],
            'gauche': [
                pygame.transform.flip(pygame.image.load("animations_sprites/images/" + nom + '_d' + str(i) + '.png'),
                                      True, False) for i in range(1, 9)]}
        self.direction = 'bas'
...
class Enemy:
    ...
    def __init__(self, nom):
        self.sprites = [pygame.image.load("animations_sprites/images/" + nom + '' + str(i) + '.png') for i in
                        range(1, 4)]
